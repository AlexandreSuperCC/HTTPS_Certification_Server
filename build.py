...
SERVER_PASSWORD = 'server_ycao'# A compléter

CA_CONFIGURATION = Configuration('FR', 'Franche-Comté', 'Belfort', 'UTBM', 'www.ca.com', ['www.ca_alt.com']) # A compléter
SERVER_CONFIGURATION = Configuration('CH', 'Shanghai', 'Shanghai', 'SHU', 'www.server.com', ['www.server_alt.com']) # A compléter
...
signed_certificate = certificate_authority.sign(server.get_csr(), SERVER_PUBLIC_KEY_FILENAME)# A compléter
